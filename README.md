...
I am a driven **Full-Stack Web Developer** and an undergraduate student pursuing my **B.Tech in Computer Engineering (2027)**. I thrive on architecting clean, responsive, and scalable web applications from frontend user experiences to robust backend APIs.

- 🔭 **Currently working on:** Improving backend scalability & writing clean, production-level code.
- 📚 **Currently learning:** System Design, Cloud Architecture, and advanced database optimization.
- 💡 **Philosophy:** *"I build, break, and improve — every day."*
- 💬 **Ask me about:** React, Next.js, Node.js, Express, MongoDB, and REST APIs.
...
| 🎬 **Crazyxani — Anime Streaming Platform** | 📦 **Inventory Management System (REST API)** |
| :--- | :--- |
| • Built with **Next.js**, **Node.js**, and **MongoDB**.<br>• Integrated **Anilist API** for rich real-time anime data & metadata.<br>• Features seamless video streaming, advanced search, and user watchlist.<br>• Server-Side Rendering (SSR) for optimal performance & SEO. | • Robust RESTful API built with **Node.js**, **Express.js**, and **MySQL**.<br>• Secure **JWT Authentication** and role-based authorization.<br>• Full CRUD operations for products, orders, and stock management.<br>• End-to-end API testing and documentation using **Postman**. |
...
<div align="center">
  <sub>Proudly built by Aditya Lohar ⚙️ Every line of code is a step towards mastery.</sub>
</div>
